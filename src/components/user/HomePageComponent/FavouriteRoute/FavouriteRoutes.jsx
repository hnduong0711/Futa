    ...
    <div className="mt-10 w-screen -mx-50 bg-futa-primary/5 p-4">
      <div className="mx-50 space-y-4">
        ...
        <div className="grid grid-cols-3 gap-6">
          {/* 1 route */}
          <div className="shadow-[0_0_14px_rgba(0,0,0,0.1)] flex flex-col rounded-lg bg-white">
            <div className="relative">
              <img src={Fr1} alt="" />
              <div className="flex flex-col absolute bottom-3 z-10 pl-2 text-white ">
                <span className="">Tuyến xe từ</span>
                <span className="font-semibold text-xl">Hồ Chí Minh</span>
              </div>
            </div>
            {/* 3 đích đến */}
            <div className="grid grid-rows-3">
              <div className="flex justify-between border-b-2 border-gray-200 p-4 cursor-pointer hover:bg-gray-100">
                <div className="flex flex-col">
                  <span className="text-futa-heading font-semibold text-[18px]">Đà Lạt</span>
                  <span className="text-gray-500">
                    305km - 8 giờ - 04/03/2025
                  </span>
                </div>
                <div className="text-futa-heading">290.000đ</div>
              </div>
              <div className="flex justify-between border-b-2 border-gray-200 p-4 cursor-pointer hover:bg-gray-100">
                <div className="flex flex-col">
                  <span className="text-futa-heading font-semibold text-[18px]">Đà Lạt</span>
